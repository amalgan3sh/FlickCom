 ...
 <body className='snippet-body'>
    ...
    <div class="row">
            ...
            <div class="p-3 py-5">
                    ...
                    <center><h4><i><b>Vacancies For Production Assistant</b></i></h4></center>
  ...
  $query1=mysqli_query($query,"SELECT * FROM `tbl_vaccancy` WHERE Vaccancy_feild='Production Assistant'");

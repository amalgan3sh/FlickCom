...
.add-experience:hover {
 ...
 <body className='snippet-body'>
  ...
  $query1=mysqli_query($query,"SELECT * FROM `tbl_freshers` INNER JOIN `tbl_vaccancy` ON tbl_freshers.Vaccancy_feild = tbl_vaccancy.Vaccancy_feild");
       ...
       while($query2=mysqli_fetch_array($query1))
{
   ...
   <tr class="table-success"> 
    ...
    <td><a href="apply.php?field=<?php echo $query2['vaccancy_id'];?>"><button type="button" class="btn  btn-info">Apply</button></a></td>

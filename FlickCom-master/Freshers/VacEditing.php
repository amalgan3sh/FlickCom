...
.add-experience:hover {
 ...
 <body className='snippet-body'>
  ...
  $query1=mysqli_query($query,"SELECT * FROM `tbl_fresher` INNER JOIN `tbl_vaccancy` ON tbl_fresher.field = tbl_vaccancy.field");
       ...
       while($query2=mysqli_fetch_array($query1))
{
   ...
   <tr class="table-success"> 
    ...
    <td><a href="apply.php?field=<?php echo $query2['field'];?>"><button type="button" class="btn  btn-info">Apply</button></a></td>

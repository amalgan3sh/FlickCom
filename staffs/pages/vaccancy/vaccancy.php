    ...
    <div class="pcoded-content">
        <!-- [ breadcrumb ] start -->
          ...
          <div class="row">
            <div class="col-md-17">
              <div class="card">
                <form class="form-horizontal" method="post" action="AddingVaccancy.php" name="registration" class="registartion-form" onsubmit="return function()>
                  ...
                  <center>
                    <h4 class="card-title">Add New Vacancy</h4>
                     ...
                     <div class="form-group row">
                        <label for="field"
                        class="col-sm-5 text-end control-label col-form-label">Vacancy Field *</label>
                        <div class="col-sm-7">
...
<option value="<?php echo $row['field'];?>"><?php echo $row['field'];?></option><?php } ?>
                    ...
                    <div class="form-group row">
                      <label
                        ...
                        >Total Vaccancy*</label
                      >
                      <div class="col-sm-7">
                        <input
                          type="text"
                          class="form-control"
                          id="novaccancy" name="novaccancy"
                          placeholder="Number of Vaccancies" required
                        onchange="Validatevac();"
...
<option value="<?php echo $row['qualification'];?>"><?php echo $row['qualification'];?></option><?php } ?>
        ...
        >Experience*</label
                      ...
                      <div class="col-sm-7">
                        <input
                          type="text" maxlength="2" minlength="1"
                          class="form-control"
                          id="experience" name="experience"
                          placeholder="Experience" required onchange="Validatexep();"
    ...
    return true;
                    ...
                    <div class="form-group row">
                      <label
                        for="deadline"
                        class="col-sm-5 text-end control-label col-form-label"
                        >Deadline for Application*</label
                      >
                      <div class="col-sm-7">
                        <input
                          type="date"
                          ...
                          placeholder="Date of last submition" min='2022-01-01' max='2024-01-01' required
...
<script type="text/javascript">
    $(function () {
        ...
        $('[id*=deadline]').attr('min', date);
                  ...
                  <center><button type = "submit" name="submit" class="btn btn-success" ><i class="feather mr-2 icon-check-circle"></i>ADD VACCANCY</button>
                 </center>
                </form>
            </div>
        </div>

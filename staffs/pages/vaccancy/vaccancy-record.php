...
<section class="pcoded-main-container">
  ...
  $query1=mysqli_query($query,"SELECT * FROM `tbl_vaccancy`");
       ...
       while($query2=mysqli_fetch_array($query1))
{
   ...
   <tr class="table-success"> 
    ...
    <td><a href="deletevaccancy.php?vaccancy_id=<?php echo $query2['vaccancy_id'];?>"><button type="button" class="btn  btn-danger">Delete</button></a></td>



    <td><a href="updatevaccancy.php?vaccancy_id=<?php echo $query2['vaccancy_id'];?>"><button type="button" class="btn  btn-info">Edit</button></a></td>
    </tr>
